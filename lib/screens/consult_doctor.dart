...
class _ConsultDoctorState extends State<ConsultDoctorScreen> {
          ...
          builder: (context, doctorList, child) {
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                speciality = speciality.trim().isEmpty
                    ? 'Not Specified'
                    : speciality.trim();
                ...
                return ListTile(
                    leading: CircleAvatar(
                      backgroundImage: doctors[index].profileImage.isEmpty
                          ? AssetImage('assets/images/user-silhouette.png')
                          : NetworkImage(doctors[index].profileImage),
  ...
  void _displayDoctorInfo(KnockUser doctor) {
    String fullname = doctor.firstName + ' ' + doctor.lastName;
    fullname = fullname.trim().isEmpty ? 'Doctor' : fullname.trim();

    String speciality = doctor.doctorSpeciality;
    speciality =
        speciality.trim().isEmpty ? 'Not Specified' : speciality.trim();
    speciality =
        speciality.substring(0, 1).toUpperCase() + speciality.substring(1);
              ...
              child: Column(
                children: <Widget>[
                  Padding(
                    ...
                    child: CircleAvatar(
                      backgroundImage: doctor.profileImage.isEmpty
                          ? AssetImage('assets/images/user-silhouette.png')
